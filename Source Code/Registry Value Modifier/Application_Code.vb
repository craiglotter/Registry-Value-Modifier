...
Module Application_Code
    ...
    Sub Main(ByVal sArgs() As String)
        Try
            If Not sArgs.Length = 4 Then
                Console.WriteLine("Registry Value Modifier")
                Console.WriteLine("-------------------------")
                Console.WriteLine("Usage: executable [RegistryRoot] [RegistryKey] [ValueName] [Data]")
                ...
                Console.WriteLine("   - [ValueName]: the name of the Value for which the data is to be set")
                Console.WriteLine("   - [Data] is the actual string value to be used in modifying the registry value.")
            Else
                Console.WriteLine(SetRegKeyValue(sArgs(0), sArgs(1), sArgs(2), sArgs(3)))
            End If
    ...
    Private Sub Error_Handler(ByVal ex As Exception, Optional ByVal identifier_msg As String = "")
        ...
        Catch exc As Exception
            Console.WriteLine("An error occurred in Registry Value Modifier's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
